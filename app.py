...
if vision_model_name == "Claude 3.7 Sonnet":
    with st.expander("Informações sobre pensamento estendido"):
        st.markdown(f"""
        **Pensamento Estendido Ativado**
        - Limite de tokens para pensamento: {CLAUDE_37_SONNET_CONFIG['thinking_tokens_limit']} tokens
        - O modelo utilizará raciocínio passo a passo para análise mais profunda
